...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.code, code) || other.code == code));
}
...
@override
String toString() {
  return 'VerifyRequest(email: $email, code: $code)';
}
...
class _VerifyRequest implements VerifyRequest {
  const _VerifyRequest({required this.email, required this.code});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.code, code) || other.code == code));
}
