...
import 'package:slipwise/modules/auth/presentation/hooks/verify_otp_hook.dart';
import 'package:slipwise/modules/auth/providers/notifier/verify_otp_notifier.dart';
...
class VerifyOtpScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      Future.microtask(() {
        ref.read(verifyOtpProvider.notifier).resendOtp(email);
        if (context.mounted) {
