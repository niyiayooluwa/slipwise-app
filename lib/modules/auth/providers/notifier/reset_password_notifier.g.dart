...
final class ResetPasswordNotifierProvider
    extends $AsyncNotifierProvider<ResetPasswordNotifier, void> {
...
String _$resetPasswordNotifierHash() =>
    r'8b55dbcf519f5dc6643aaa0d7f55d2d88911c97b';

abstract class _$ResetPasswordNotifier extends $AsyncNotifier<void> {
  FutureOr<void> build();
  @$mustCallSuper
  @override
  void runBuild() {
