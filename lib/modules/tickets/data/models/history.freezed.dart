...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String? description, @JsonKey(name: 'overall_status')  String overallStatus,  String provider,  double? stake, @JsonKey(name: 'ticket_id')  String ticketId, @JsonKey(name: 'total_odds')  double totalOdds, @JsonKey(name: 'tracked_at')  DateTime trackedAt, @JsonKey(name: 'total_legs', defaultValue: 0)  int totalLegs, @JsonKey(name: 'won_legs', defaultValue: 0)  int wonLegs, @JsonKey(name: 'lost_legs', defaultValue: 0)  int lostLegs, @JsonKey(name: 'pending_legs', defaultValue: 0)  int pendingLegs, @JsonKey(name: 'is_archived', defaultValue: false)  bool isArchived, @JsonKey(name: 'archived_at')  DateTime? archivedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HistoryItem() when $default != null:
return $default(_that.code,_that.description,_that.overallStatus,_that.provider,_that.stake,_that.ticketId,_that.totalOdds,_that.trackedAt,_that.totalLegs,_that.wonLegs,_that.lostLegs,_that.pendingLegs,_that.isArchived,_that.archivedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String? description, @JsonKey(name: 'overall_status')  String overallStatus,  String provider,  double? stake, @JsonKey(name: 'ticket_id')  String ticketId, @JsonKey(name: 'total_odds')  double totalOdds, @JsonKey(name: 'tracked_at')  DateTime trackedAt, @JsonKey(name: 'total_legs', defaultValue: 0)  int totalLegs, @JsonKey(name: 'won_legs', defaultValue: 0)  int wonLegs, @JsonKey(name: 'lost_legs', defaultValue: 0)  int lostLegs, @JsonKey(name: 'pending_legs', defaultValue: 0)  int pendingLegs, @JsonKey(name: 'is_archived', defaultValue: false)  bool isArchived, @JsonKey(name: 'archived_at')  DateTime? archivedAt)  $default,) {final _that = this;
switch (_that) {
case _HistoryItem():
return $default(_that.code,_that.description,_that.overallStatus,_that.provider,_that.stake,_that.ticketId,_that.totalOdds,_that.trackedAt,_that.totalLegs,_that.wonLegs,_that.lostLegs,_that.pendingLegs,_that.isArchived,_that.archivedAt);case _:
  throw StateError('Unexpected subclass');
